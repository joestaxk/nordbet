...
import OddButton from './OddButton.vue';
  ...
  <div class="text-white space-y-2 w-[400px] p-[12px_8px_8px] bg-skinLight max-h-full rounded-[8px]">
    ...
    <div class="flex-1 text-skinTextMuted flex relative text-left">
      <div class="flex gap-1 font-bold text-[12px]">
        <span>
          <svg data-cy="sport-soccer" width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
            class="sc-1x10e4w-1 bcIndF sc-xztl6g-2 dgAXLq"
        ...
        <span class="flex gap-1 leading-[100%] items-center">
          <span>{{ country }}</span>
          <span class="rotate-180">
            <svg data-cy="ic-rounded-arrow" width="16" height="16" viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg" class="sc-1x10e4w-1 bcIndF sc-xztl6g-3 ghjiKB"
    ...
    <!-- Match time and icons -->
    <div class="flex items-center text-skinTextMuted gap-2 text-[12px] font-bold">
      <span>{{ date }},</span>
      <span>{{ time }}</span>
      <span>
        <!-- Live icon SVG unchanged -->
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
          class="sc-1x10e4w-1 bcIndF bt4142"
      ...
      <span>
        <!-- Bet builder icon SVG unchanged -->
        <svg data-cy="bet-builder" width="16" height="16" viewBox="0 0 16 16" fill="none"
          xmlns="http://www.w3.org/2000/svg" class="sc-1x10e4w-1 bcIndF bt4878"
          style="fill: currentcolor; color: rgb(33, 168, 247); width: auto; height: 16px;">
          <path
    ...
    <div class="space-y-2 font-[600]">
      <div class="flex items-center gap-2">
        <img src="/images/assetsModule/sport/images/a.png" class="w-[28px]" alt="Team 1" />
        <p>{{ team1 }}</p>
      </div>
      <div class="flex items-center gap-2">
        <img src="/images/assetsModule/sport/images/2826.png" class="w-[28px]" alt="Team 2" />
        <p>{{ team2 }}</p>
      </div>
    </div>

    <!-- Odds section -->
    <p class="text-[12px] text-skinTextMuted">1x2</p>
    <div class="flex gap-2 justify-between">
      <OddButton :market="1" :odd="odds.team1" />
      <OddButton market="draw" :odd="odds.draw" />
      <OddButton :market="2" :odd="odds.team2" />
      <button
        class="h-[35px] hover:bg-[#242829] text-white cursor-pointer flex p-[0px_8px] overflow-hidden relative bg-[#3a4142] font-[600] leading-[30px] justify-center items-center rounded-[8px] transition-colors">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-down-fill"
          viewBox="0 0 16 16">
          <path
