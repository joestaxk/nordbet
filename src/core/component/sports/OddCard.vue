...
<template>
    <div class="text-white space-y-2 w-[400px] p-[12px_8px_8px] bg-[#292d2e] max-h-full rounded-[8px]">
            ...
            <div class="flex gap-1 font-bold text-[12px]">
                <span>
                    <svg data-cy="sport-soccer" width="32" height="32" viewBox="0 0 32 32"
                        xmlns="http://www.w3.org/2000/svg" class="sc-1x10e4w-1 bcIndF sc-xztl6g-2 dgAXLq"
