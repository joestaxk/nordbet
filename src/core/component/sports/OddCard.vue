...
<template>
  <div
    class="text-white space-y-2 w-[400px] p-[12px_8px_8px] bg-skinLight max-h-full rounded-[8px]"
  >
        ...
        <span class="flex gap-1 leading-[100%] items-center">
          ...
          <span class="rotate-180">
            <svg
              ...
              viewBox="0 0 16 16"
              xmlns="http://www.w3.org/2000/svg"
              class="sc-1x10e4w-1 bcIndF sc-xztl6g-3 ghjiKB"
    ...
    <div class="flex items-center text-skinTextMuted gap-2 text-[12px] font-bold">
      ...
      <span>
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          class="sc-1x10e4w-1 bcIndF bt4878"
