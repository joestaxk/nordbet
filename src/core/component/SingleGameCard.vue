<template>
    <div class="xs:w-[195px] h-[240px] rounded-[8px] overflow-hidden hover:scale-[1.02] duration-100 ease-in group"
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex gap-2 items-center">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                            size="13" color="#2aee88" top="-1" style="margin-left: auto;" class="css-g26q68">
                            <path
