...
<template>
    <Carousel :slides="sortedData" :id="3094893" height="auto" :space-between="10" :min-slide-width="198"
        ...
        <template #slide="{ slide, index }" class="min-w-[200px] w-full">
            <div class="grid grid-rows-2 gap-y-2">
                <SingleGameCard v-bind="slide[0][0]" />
                <SingleGameCard v-bind="slide[0][0]" />
            </div>
        </template>
    </Carousel>
