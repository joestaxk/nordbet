...
import CarouselOddCard from '@/core/component/sports/CarouselOddCard.vue';
...
<template>
  <Carousel :slides="mockMatches" :id="122233" height="auto" :min-slide-width="400" :space-between="0"
    @slide-change="handleSlideChange">
    <template #header>
      <div class="flex  items-center gap-2">
        <div class="flex items-center text-[16px] text-white font-[700] gap-2">
          <svg data-cy="sport-soccer" class="text-skinTextMuted" width="32" height="32" viewBox="0 0 32 32"
            xmlns="http://www.w3.org/2000/svg" style="fill: currentcolor; color: inherit; width: auto; height: 22px;">
        ...
        <RouterLink to="/sports" class="text-lemon font-bold">View All</RouterLink>
      </div>
    </template>

    <template #slide="{ slide }">
      <CarouselOddCard v-bind="slide" class="min-w-[198px] w-full" />
    </template>
  </Carousel>
</template>